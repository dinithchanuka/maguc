...
var PRESETS = map[string]PresetLocations{
	...
	"germany":      PresetLocations{"germany", "deutschland", "berlin", "frankfurt", "munich", "m%C3%BCnchen", "hamburg", "cologne", "k%C3%B6ln", "dortmund", "bremen"},
